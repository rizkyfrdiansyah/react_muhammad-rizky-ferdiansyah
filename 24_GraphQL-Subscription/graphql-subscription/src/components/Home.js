...
function Home() {
  ...
  const [deletePassanger, { loading: loadingDelete }] = useMutation(DeletePassangers, {
    refetchQueries: [GetAllPassengers],
  });
  ...
  return (
    <div>
      <Header />
      <ListPassenger deletePassangers={hapusPenumpang} data={data} loading={insertLoading || loading || loadingDelete} error={error} />
